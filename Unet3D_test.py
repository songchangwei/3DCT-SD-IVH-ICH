...
def main(tempdir):
    ...
    saver = SaveImage(output_dir="./unet_output", output_ext=".nii.gz", output_postfix="seg")
    ...
    model.load_state_dict(torch.load("unet_best_metric_model_segmentation3d_array.pth"))
    model.eval()
    with torch.no_grad():
