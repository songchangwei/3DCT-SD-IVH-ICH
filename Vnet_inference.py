...
def main(tempdir):
    ...
    post_transform = Compose(
        [
            ...
            SaveImaged(keys="pred", output_dir="./VNet_out", output_ext=".nii.gz", output_postfix="seg"),
    ...
    model.load_state_dict(torch.load("vnet_best_metric_model_segmentation3d_array.pth"))
